...
import themeSelectorStyle from "./styles/themeSelector.scss"
...
export default ((opts?: Options) => {
  ...
  `
  Footer.afterDOMLoaded = themeSelectorScript
  Footer.css = style + darkmodeStyle + themeSelectorStyle
  return Footer
